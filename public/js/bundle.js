        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Connexion réussi!');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"animeAdmin.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.animeAdmin = void 0;
...
//   }
// };
var animeAdmin = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Anime ajouté avec succès!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function animeAdmin(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.animeAdmin = animeAdmin;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateAnime.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateAnime = void 0;
...
var updateAnime = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(form, id) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function updateAnime(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var _animeAdmin = require("./animeAdmin");

var _updateAnime = require("./updateAnime");
...
var animeAdminForm = document.querySelector('.form-anime-data');
var updateAnimeForm = document.querySelector('.form-anime-update-data');
var reviewAnimeForm = document.querySelector('.form-anime-review'); // DELEGATION
...
if (updateAnimeForm) updateAnimeForm.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (animeAdminForm) animeAdminForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData();
  form.append('name', document.getElementById('name').value);
  form.append('imageCover', document.getElementById('imageCover').files[0]);
  ...
  console.log(form);
  (0, _animeAdmin.animeAdmin)(form, 'data');
});
